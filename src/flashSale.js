...
// Stop if timer elements don't exist
if (
    !daysElement ||
    !hoursElement ||
    !minutesElement ||
    ...
    console.error("Flash Sale timer elements not found.");
} else {

    const timerStorageKey = "ksamdeal_flash_sale_end_time";

    let endTime = localStorage.getItem(timerStorageKey);

    /*
       Create a new 4 day 14 hour
       48 minute 18 second timer
    */
